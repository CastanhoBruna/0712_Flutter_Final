...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(' Escape trapp '),
        centerTitle: true,
      ),
      body: ListView(
        children: <Widget>[
          Image.asset('assets/trip.JPG'),

          Padding(
            padding: const EdgeInsets.fromLTRB(25, 10, 15, 10),
            child: RichText(
              text: TextSpan(
                text: 'O seu aplicativo de controle de ',
                style: TextStyle(fontWeight: FontWeight.w300, fontSize: 20, color: Colors.blueGrey, decoration: TextDecoration.none, ), 
                children: <TextSpan>[
                  TextSpan(
                      text: 'viagens e custos ! ',
                      style: TextStyle(fontWeight: FontWeight.w400, fontSize: 20, color: Colors.blueGrey, decoration: TextDecoration.none ),
                      ),
                ],
              ),
            ),
